...
function BenefitsScreen({ freePlan, plusPlan, waitingPeriodHours, onBack, onClose }) {
  const benefits = [
    { icon: '⚡', title: 'Instant listing alerts', description: 'Know when a matching place appears.' },
    { icon: '◉', title: 'High-fit alerts', description: 'Get notified when a strong Rental Fit is listed.' },
    { icon: '▱', title: 'Saved-search alerts', description: 'Price and status alerts for the searches and listings you follow.' },
    { icon: '▤', title: 'Full application history', description: 'See every enquiry you have sent, not just recent activity.' },
    { icon: '⇄', title: 'Compare listings', description: 'Line up shortlisted properties side by side.' },
    ...
    { icon: '↺', title: 'Rewind', description: 'Undo your last Smart Match pass.' },
    {
      icon: '⌁',
